...
test('one epoch permits one repair PR and resumes original requests only after verification', () => {
  ...
  record = recordFaultAttempt(record, { kind: 'review', target: 'agent-review', sequence: 1, outcome: 'succeeded', head: 'a'.repeat(40), at: '2026-08-16T00:02:00Z' })
  record = recordFaultAttempt(record, { kind: 'ci', target: 'controller-ci', sequence: 1, outcome: 'succeeded', head: 'a'.repeat(40), at: '2026-08-16T00:03:00Z' })
  record = recordFaultAttempt(record, { kind: 'promotion', target: 'fault-bound', sequence: 1, outcome: 'succeeded', head: 'a'.repeat(40), publishedSha: '3'.repeat(40), at: '2026-08-16T00:04:00Z' })
