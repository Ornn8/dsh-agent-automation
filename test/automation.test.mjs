...
test('unattended health combines a hosted queue watchdog, replica heartbeats, and real daily canaries', async () => {
  ...
  assert.match(maintenance, /runs-on: ubuntu-latest/)
  assert.match(maintenance, /needs: routing/)
  assert.match(maintenance, /AGENT_AUTOMATION_MAINTENANCE_REPLICA_ID is missing or invalid/)
  ...
  assert.match(maintenanceReadiness, /runs-on: ubuntu-latest/)
  assert.match(maintenanceReadiness, /needs: routing/)
  assert.match(maintenanceReadiness, /AGENT_AUTOMATION_MAINTENANCE_REPLICA_ID is missing or invalid/)
