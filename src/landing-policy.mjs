...
/** Normalize GitHub CLI's mergeable enum to the controller's boolean contract. */
/** @param {boolean | string | null | undefined} value */
export function normalizeMergeableStatus(value) {
  if (value === true || value === 'MERGEABLE') return true
  if (value === false || value === 'CONFLICTING') return false
  return null
}
